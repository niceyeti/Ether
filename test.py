...
def init():
	...
	#init the signed hashes to 0 for each host's entry
	self.registrations[0][1] = 0
	self.registrations[1][1] = 0
	self.registrations[2][1] = 0
	self.registrations[3][1] = 0
	self.registrations[4][1] = 0
	self.registrations[5][1] = 0
	self.registrations[6][1] = 0
	self.registrations[7][1] = 0
	self.registrations[8][1] = 0
	self.registrations[9][1] = 0
...
#A host submits their hash using this.
def submitHash(hostKey,hash):
	i = 0
	success = False
